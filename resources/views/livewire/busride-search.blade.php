        ...
        @if(!$results->isEmpty())
            @foreach ($results as $result)
                <div class="flex justify-center text-lg lg:text-xl p-2">
                    <div
                        class="flex flex-row items-center min-w-[800px] max-w-[800px] lg:min-w-[1000px] lg:max-w-[1000px] bg-gray-400">
                        <div
                        ...
                        <div title="Hiermee kan je een ticket kopen naar het passende busrit"
                             class="p-2 min-w-[150px] max-w-[150px] flex justify-center">
