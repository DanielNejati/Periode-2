<x-app-layout>
    <div class="flex justify-center items-center mt-15 mb-15">
        <div class="flex flex-col bg-gray-300 min-w-[1000px] max-w-[1000px] lg:min-w-[1200px] lg:max-w-[1200px]">
            ...
            <form action="{{ route('festival.update', '1')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex justify-center mt-10 mb-10">
                    <div class="flex flex-col min-w-[1000px]">
                        ...
                        <div class="flex justify-center ">
                            <button type="submit" class="bg-gray-500 hover:bg-gray-700 text-white p-2 rounded">Update</button>
                        </div>
                    </div>
                </div>
            </form>
